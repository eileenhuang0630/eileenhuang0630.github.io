...
if (reversed == null) { reversed = false; }
	...
	var mask_1_graphics_128 = new cjs.Graphics().p("AgMAbQgIgBgEgDIgGgGIgCgDIgBgEIgBgSIABgFQABgFAEgDQAEgDAFAAIAGABIAAgBQAEgCAKAAIAPABQAFABADADIADAGIADAJIACACQAFAIgEAIQgCADgEADQgGAFgIACIgHACg");
	...
	var mask_1_graphics_130 = new cjs.Graphics().p("AgOAwIgKAAIgIgEQgQgJgFgIQgDgIAAgOIABgIIACgFIAAgFQgBgGAEgFQADgFAFgEQAIgIAIgDQAIgDAKAAQAfAAAVATQAFAGACADQABAFAAAFIAAAIIABAAQAEAEAAAEQAAAGgEAIQgEAHgFAFQgHAIgNAEIgIADIgKAAg");
	...
	this.shape_1.graphics.f("#D60B2F").s().p("AhhAgQgWgWgpgfIgsglQgHgHgBgHQAqACAiAFIgCABQAYAAA7ARQBEAUANACQAYAEApgDIA7gGIAEAAQAegDAbAMQAEADgHAIIgWAVIgkAmQgdAYggAAQiSAAgogpg");
	...
	var mask_9_graphics_52 = new cjs.Graphics().p("");
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/手繪lady_atlas_1.png?1734151758481", id:"手繪lady_atlas_1"}
	],
	preloads: []
};
